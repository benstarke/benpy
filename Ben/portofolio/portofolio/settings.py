...
#SECRET_KEY = 'a3=)7e-7#24tq$_=k0u430^(-a-d4(5l1o!@7t#r0v=rql11z3'

SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY','a3=)7e-7#24tq$_=k0u430^(-a-d4(5l1o!@7t#r0v=rql11z3' )
...
AWS_STORAGE_BUCKET_NAME = 'benstar-blog'
...
DEFAULT_FILE_STORAGE = 'portofolio.storage_backends.MediaStorage'
